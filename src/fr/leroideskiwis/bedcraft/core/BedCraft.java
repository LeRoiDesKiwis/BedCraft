...
import fr.leroideskiwis.bedcraft.listeners.*;
import fr.leroideskiwis.bedcraft.commands.RegisterCommand;
...
public class BedCraft extends JavaPlugin {
    ...
    public void onEnable() {
        ...
        this.duels = new Duels(this, customPlayerManager);
        ...
        pluginManager.registerEvents(new DamageEvents(customPlayerManager, duels), this);
